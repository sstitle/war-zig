...
pub fn build(b: *std.Build) void {
    ...
    // This project provides a library module that can be used by other Zig programs.
    // Two example executables demonstrate the library functionality:
